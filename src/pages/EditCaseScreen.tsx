  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (res.result === "failed") {
        ...
        setEditForm(prev => ({ ...prev, ...res, date }));
        setPerson(res.known ? 1 : 0);
        setVisibleMark(res.visible_marks === 1);
      }
    } catch (err) {
      hideLoader();
    ...
    <ScrollView>
      <View>
        ...
        <TextInput
          ...
          value={editForm.indent}
          onChangeText={value => handleInputChange('indent', value)}
        />

        <TextInput
          placeholder="Distinguishing clothing"
          value={editForm.cloth}
          onChangeText={value => handleInputChange('cloth', value)}
        />
